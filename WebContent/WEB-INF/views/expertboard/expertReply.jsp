...
// function fmcheck(){
// 	frm.action = "<%=request.getContextPath() %>/expertboard/reply";
...
<div>
<form action="<%=request.getContextPath() %>/expertboard/reply" method="post" enctype="multipart/form-data" id="frm">
<!-- <form onsubmit="fmcheck();" method="post" enctype="multipart/form-data" id="frm"> -->
<%-- <input type="hidden" name="groupno" value="${viewBoard.postno }"> --%>
<input type="hidden" name="groupno" value="${viewBoard.postno }">
<input type="hidden" name="depth" value="1">
<input type="hidden" name="groupord" value="1">
