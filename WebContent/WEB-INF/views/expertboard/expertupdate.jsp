...
<script type="text/javascript"
 src="/anibuddy/resources/se2/js/service/HuskyEZCreator.js" charset="utf-8"></script>
...
<div>
<form action="<%=request.getContextPath() %>/expertboard/update" method="post" enctype="multipart/form-data">
...
<div>
기존 첨부파일 : 
<a href="<%=request.getContextPath() %>/upload/${boardFile.storedname }"
