...
<div class="o3-content">
	...
	<div class="o3-cont">
		<table class="" >
		<tr>
		<td class="bgBlue">제목</td><td colspan="3">${detailO3.title }</td>
		</tr>
	
		<tr>		
		<td class="bgBlue">작성일</td><td colspan="3">${detailO3.writeDate }</td>
		</tr>
		...
		<tr>
		<td class="bgBlue">답변 제목</td><td colspan="3">${q.title }</td>
		</tr>

		<tr>		
		<td class="bgBlue">답변 작성일</td><td colspan="3" >${q.writeDate }</td>
		</tr>

		<tr><td class=""  colspan="4">답변 내용</td></tr>
		<tr><td colspan="4" class="height300 text-left" >${q.content }</td></tr>
		</c:if>
