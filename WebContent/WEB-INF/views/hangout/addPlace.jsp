...
<div class="top">
	<h2>놀거리 <span class="h2-inner"> 장소 추가</span></h2>
</div>

<div class="a-content">

<form class="form-horizontal" action="<%=request.getContextPath() %>/hangout/insert" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
			...
			<div class="col-sm-10">
				<label class="radio-inline"><input type="radio" id="filter" name="filter" value="카페">카페</label>
				<label class="radio-inline"><input type="radio" id="filter" name="filter" value="식당">식당</label>
				<label class="radio-inline"><input type="radio" id="filter" name="filter" value="펜션">펜션</label>
				<label class="radio-inline"><input type="radio" id="filter" name="filter" value="캠핑장">캠핑장</label>
				<label class="radio-inline"><input type="radio" id="filter" name="filter" value="운동장">운동장</label>
...
<!-- 		<span class="img-info">사진은 최대 4장까지 추가할 수 있습니다</span> -->
	...
	<div class="form-group">
		<label for="email" class="control-label col-sm-2 lab">이메일</label>
		<div class="col-sm-10"><input type="email" class="form-control add" name="email" id="email" placeholder="ex)  example@anibuddy.com"></div>
	</div>
