...
<tr><td class="info">답변 제목</td><td><input type="text" id="title" name="title" style="width:100%" value="[답변] ${o3.title }" /></td></tr>
...
<div class="text-center">	
	<button type="button" id="btnO3Reply" class="btn btn-info" style="margin-top: 0;" >1:1답변하기</button>
