...
<ul class="pagination pagination-sm">
	...
	<c:if test="${paging.curPage eq i }">
		<li class="active"><a href="/anibuddy/board/expert?curPage=${i }">${i }</a></li>
	</c:if>
	
	<!-- 보고 있는 페이지번호가 아니면 평소 모양으로 보여주기 -->
	<c:if test="${paging.curPage ne i }">
		<li><a href="/anibuddy/board/expert?curPage=${i }">${i }</a></li>
	</c:if>
	...
	<li><a href="/anibuddy/board/expert?curPage=${paging.startPage + paging.pageCount }">&raquo;</a></li>
	</c:if>
	...
	<li><a href="/anibuddy/board/expert?curPage=${paging.totalPage }">&rarr;</a></li>
	</c:if>
</ul>
</div>