...
@WebServlet("/hangout/bmInsertLocation")
public class HangOutInsertLocationBookMarkController extends HttpServlet {
...
//		System.out.println("hangout/bmInsertLocation - [POST]");
		...
		hangoutService.insertBookMark(bm);
