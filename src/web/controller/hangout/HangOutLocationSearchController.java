...
@WebServlet("/hangout/locationSearch")
public class HangOutLocationSearchController extends HttpServlet {
...
//		System.out.println("/anibuddy/hangout/locationSearch - [POST]");
		...
		hangout.sethName(req.getParameter("name"));
		
		List<HangOut> placeList = hangoutService.viewLocation(hangout);
