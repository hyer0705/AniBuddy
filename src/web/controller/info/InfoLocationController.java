...
@WebServlet("/info/location")
public class InfoLocationController extends HttpServlet {
...
//		System.out.println("/anibuddy/info/location - [GET]");
		...
		req.getRequestDispatcher("/WEB-INF/views/info/locationSearch.jsp").forward(req, resp);
	}
