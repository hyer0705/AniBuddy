...
@WebServlet("/info/citySearch")
public class InfoCitySearchController extends HttpServlet {
...
//		System.out.println("/anibuddy/info/citySearch - [POST]");
		...
		List<Info> placeList = infoService.viewCity(info);
