...
/**
 * Servlet implementation class PostMessageDeleteSendPmController
 */
@WebServlet("/mypage/deletesendpm")
public class PostMessageDeleteSendPmController extends HttpServlet {
...
private PostMessageService pmService = new PostMessageServiceImpl();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 쪽지리스트로 리다이렉트
		resp.sendRedirect("/anibuddy/mypage/sendpmlist");
